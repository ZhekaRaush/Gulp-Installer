...
3. Инициализация наберите в терминале: npm init  
4. Выполнить команду: npm i (необходимо перед началом сборки установить node.js)  
5. Необходимо глобально установить GULP-CLI: npm i -g gulp-cli
6. Выполните команду: gulp dev (запуск таска для работы с приложением)  
